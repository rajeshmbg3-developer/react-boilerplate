export const PageNotFound = (): JSX.Element => (
  <svg
    ...
    xmlSpace="preserve"
  >
    {/* <circle style={{fill:'#1976D2'}} cx="254.644" cy="254.644" r="254.644"/> */}
    <rect x="71.205" y="100.026" style={{ fill: "#eeeeee" }} width="366.877" height="51.878" />
    <rect x="71.205" y="151.905" style={{ fill: "#eeeeee" }} width="366.877" height="257.356" />
    ...
    <g>
      <path
        style={{ fill: "#DEDEDF" }}
        d="M359.078,117.997H186.49c-4.408,0-8.138,3.73-8.138,8.138c0,4.408,3.73,8.138,8.138,8.138h172.588
    ...
    {/* <path
      style={{ fill: "#333842" }}
      d="M403.836,124.779l-4.747-4.747c-0.678-0.678-1.695-0.678-2.374,0c-0.678,0.678-0.678,1.695,0,2.374
    ...
    <g>
      <path
        style={{ fill: "#1976D2" }}
        d="M253.287,326.188c-25.091,0-45.775-20.683-45.775-45.775s20.683-45.775,45.775-45.775
      ...
      <path
        style={{ fill: "#1976D2" }}
        d="M178.691,325.171c-3.73,0-6.781-3.052-6.781-6.781V303.47h-38.654c-2.713,0-4.747-1.356-6.103-3.73
      ...
      <path
        style={{ fill: "#1976D2" }}
        d="M361.113,325.171c-3.73,0-6.781-3.052-6.781-6.781V303.47h-38.315c-2.713,0-4.747-1.356-6.103-3.73
